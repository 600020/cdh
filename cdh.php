...
<body>
    <header>
        ...
        <div class="bl1">
                ...
                <p><strong>Note:</strong> This sample code has been completed by Theo and serves as an graded assignment.
                </p>
                <p>
                <a href="cdhlogin.php">Please Log In</a>
                </p>
                <p>
                Attempt to go to
                <a href="cdhgame.php">game.php</a> without logging in - it should fail with an error message.
                </p>
